...
public class ViewByFragment extends Fragment {
    public static final int MEMORY=0, WHEN=1, LOCATION=2, TAG=3, LINK=4;
    private int checked;

    public ViewByFragment(int checked)  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final RadioGroup view=(RadioGroup)inflater.inflate(R.layout.fragment_view_by, container,
                false);
